...
<p align="center">
  <a href="https://github.com/zqiren/Orbital/releases/download/v0.5.2/Orbital-Setup-0.5.2.exe"><strong>Windows Installer (.exe)</strong></a> &nbsp;&middot;&nbsp;
...
1. Download [`Orbital-Setup-0.5.2.exe`](https://github.com/zqiren/Orbital/releases/download/v0.5.2/Orbital-Setup-0.5.2.exe) from [Releases](https://github.com/zqiren/Orbital/releases/tag/v0.5.2) (latest Windows build)
