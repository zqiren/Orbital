...
| 21 | **Project-level sub-agent deployment instructions** | 2026-07-16 · implementation complete on `codex/cursor-grok-subagents`; optional project-level textarea under Project Settings → Sub-Agents, English + Simplified Chinese UI, project/API persistence with a 4,000-character limit, management-prompt-only injection, chat/queue/trigger construction parity, and next-management-call live refresh for existing sessions. Empty preserves prior behavior; no routing engine or active-supervision expansion. Automated suites and isolated real-daemon/UI/mobile/queue smoke passed. Awaiting human diff review/merge. S. See Spec 21. |
...
**Status:** Cursor-only v1 implemented; provider/account live gates remain · **Added:** 2026-07-13 · **Implemented:** 2026-07-16
...
**Status:** implemented, awaiting human diff review · **Added:** 2026-07-16 · **Decisions:** normally-binding instructions + next-management-call application
